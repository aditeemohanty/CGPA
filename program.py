...
#--------------------------------------------------------------------------------------------------------
def Grade_pointer():
    option = int(input("Enter 1 for Semester 1 and Enter 2 for Semester 2: "))
    if option == 1:
        ...
        # Print or return the calculated grade pointers
        #print("Grade pointers for Semester 1 subjects are:", g1)
#-------------------------------------------------------------------------------------------------        
    else:
...
def cgpa():
    ...
    print("Enter the marks in each subject of SEMESTER 1 first and then of SEMESTER 2.")
    ...
    print("YOUR CGPA FOR SEMESTER 1 & 2 IS:", cgpa)
#print cgpa
